...
/*Institute Apis*/
router.post('/institute/insert', uploads.array('imageSet', 10), institute.insertInstitute);//changed to single by sulaiman
...
//degree Apis
router.post('/degree/insert', auth, uploads.array('imageSet', 10), course.insertDegree)
